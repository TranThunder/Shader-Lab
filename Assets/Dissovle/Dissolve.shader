...
////// Emissive:
                ...
                float3 node_9347 = (i.uv0.g+_noise_var.rgb);
                float _node_5626_var = UNITY_ACCESS_INSTANCED_PROP( Props, _node_5626 );
                fixed4 finalRGBA = fixed4(finalColor,(step(node_9347,_node_5626_var)*step(_noise_var.rgb,_node_5626_var)).r);
